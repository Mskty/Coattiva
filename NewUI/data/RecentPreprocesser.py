...
class RecentPreprocesser:
    """
    Classe che espone metodi per effettuare preoprocessamento su dati riferiti a titoli recenti aggregati
    forniti da un utente a partire da file che rispetti il rispettivo tracciato e salvati poi su un oggetto
    di tipo Dataframe pandas. Lo scopo di tali operazioni è diestrarre ulteriori informazioni dai dati puliti
    da utilizzare nella classificazione. Espone metodi per trattare le diverse fasi del preprocessamento per tali dati,
