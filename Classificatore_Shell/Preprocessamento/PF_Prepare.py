...
def prepare_pf(dfPF: pd.DataFrame):
    """
    ...
    :param dfPF: dataframe di titoli aggregati riferiti a Persone Fisiche con tracciato di colonne identico ai dati storici aggregati e puliti
    ...
    # (eccetto DataCaricoTitolo nei dati storici che verrà utilizzato per definire training set e test set)
